...
&raquo; The thing is, before copy paste work, you have to configure settings at Codepen. 

&raquo; Just setup you **Babel transpiler**, add **React** libraries and then try as shown in the below image.
